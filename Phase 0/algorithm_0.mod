...
# --------------------------------------------------------------------------------------------------------
# KKT FORMULATION WITHOUT COMPLEMENTARITIES
# --------------------------------------------------------------------------------------------------------
### OBJECTIVE ###
# No demand curves
...
### CONSTRAINTS ###								            
subject to x_pos {i in I, t in T}: x[i,t] >= 0;
subject to y_pos {i in I, t in T}: y[i,t] >= 0;
subject to e_pos {i in I, t in T}: e_P[i,t] >= 0;
